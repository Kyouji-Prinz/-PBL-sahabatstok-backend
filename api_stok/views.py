...
def api_predict(request):
    if request.method == 'POST':
        ...
        try:
            ...
            #Tambahkan jembatan penerjemah ini ke nama pendek
            FRONTEND_TO_SHORT = {
                "Computer Peripherals": "Accessories", "Pens & Art Supplies": "Art",
                "Binders & Binder Accessories": "Binders", "Chairs & Chairmats": "Chairs",
                "Rubber Bands": "Fasteners", "Office Furnishings": "Furnishings",
                "Telephones & Communication": "Phones", "Storage & Organization": "Storage",
                "Scissors, Rulers & Trimmers": "Supplies", "Copiers & Fax": "Copiers",
                "Office Machines": "Machines"
            }
            ...
            if tipe_prediksi == 'monthly':
                ...
                # Terjemahkan dulu ke nama pendek, baru cari di MODEL_MAPPING buatanmu
                nama_pendek = FRONTEND_TO_SHORT.get(nama_produk, nama_produk)
                nama_file_model = MODEL_MAPPING.get(nama_pendek)
            ...
            if tipe_prediksi == 'monthly':
                avg_monthly_qty = prod.total_qty / 48
                ...
                avg_weekly_qty = prod.total_qty / 208
